...
if (isset($_GET['id'])) {
    $sql = "delete from forma_recebimento where id = " . $_GET['id'];
...
//2. Prepara o SQL
$sql = "select * from forma_recebimento";
...
<body>
    ...
    <div class="container">
        ...
        <div class="card mt-3 mb-3">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-card-list"></i> Listagem de Formas de Recebimento</h5>
            </div>
        </div>
        <table class="table">
            <thead>
