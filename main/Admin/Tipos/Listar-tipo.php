...
<body>
    ...
    <div class="container">
        ...
        <div class="card mt-3 mb-3">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-card-list"></i> Listagem de Categoria </h5>
            </div>
        </div>
        <table class="table">
            <thead>
            ...
            <tbody>
                <?php while ($linha = mysqli_fetch_array($resultado)) { ?>
                    <tr>
                        ...
                        <td><?= $linha['status'] ?></td>
                        <td>
                            <a class="btn btn-warning" href="categoria-alterar.php?id=<?= $linha['id'] ?>"><i
                                    class="bi bi-pencil-square"></i></a>
                            <a class="btn btn-danger" href="categoria-listar.php?id=<?= $linha['id'] ?>"
